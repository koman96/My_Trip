...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        define_mainPage_attributes(view);
        
        load_comingTrips();
        return view;
    }

    private void load_comingTrips() {
        DB db = new DB(getActivity() );
        SQLiteDatabase database = db.getReadableDatabase();

        Cursor cursor = database.rawQuery("SELECT * FROM comingTrips" ,null);
    ...
    public void define_mainPage_attributes(View view){
        ...
        pastTrips_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
        ...
        sync_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (hasData)
                    Toast.makeText(getActivity() ,"your data has been syncced" ,Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(getActivity() ,"you don't have any data" ,Toast.LENGTH_LONG).show();
            }
        });
